...
public class AssetLoader {
    ...
    public static void load() {
        ...
        dotEffectT = new Texture(Gdx.files.internal("dot_effect.png"));
        ...
        titleGameoverT = new Texture(Gdx.files.internal("title_banner_gameover.png"));
        ...
        backButton = new TextureRegion(new Texture(Gdx.files.internal("back_to_menu.png")), 0, 0,
                240,
                240);
